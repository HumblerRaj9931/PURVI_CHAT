...
BOT_TOKEN = getenv("BOT_TOKEN", "8084924766:AAFMHLP8EepOOW-uCqjPc5M51A6FnngWFCI")
OWNER_ID = int(getenv("OWNER_ID", "7403621976"))
MONGO_URL = getenv("MONGO_URL", "mongodb+srv://kvinit6421:<db_password>@cluster0.fx0jz.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
SUPPORT_GRP = getenv("SUPPORT_GRP", "bestshayri_raj")
